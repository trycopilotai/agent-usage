...
const FORECAST_ANSWERS = /* @__PURE__ */ new Set(["projected", "window_spent"]);
function hasForecast(forecast) {
  return forecast !== null && FORECAST_ANSWERS.has(forecast.status);
}
function isSpendingNow(credits) {
...
function formatDuration(seconds) {
  if (seconds === void 0 || seconds === null) return "unknown";
...
function Headroom({ providers }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "headroom", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Where there is headroom" }),
    ranked.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "muted", children: "No provider reported a limit, so there is nothing to rank." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { children: ranked.map((provider) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: provider.provider }),
      " ",
      provider.binding_window.used_percent.toFixed(
        1
      ),
      "% used",
    ...
    silent.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "muted", children: [
      ...
      " ",
      silent.map((provider) => provider.provider).join(", "),
      ". That is unknown headroom, not full headroom."
    ] }) : null,
    capped.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "muted", children: [
...
function Health({ providers }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "health", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Collection health" }),
    ...
    scraped.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "muted", children: [
      "Read through a browser rather than an API:",
      " ",
      scraped.map((provider) => provider.provider).join(", "),
      ". A scraped reading is less precise than one the provider served."
    ] }) : null,
    notLive.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "muted", children: [
      "Not current:",
      " ",
      notLive.map((provider) => `${provider.provider} (${provider.freshness})`).join(", "),
      ". Run collect for a fresh reading."
    ] }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "health__table", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "provider" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "answered" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "source" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "freshness" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { children: "adapter" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: providers.map((provider) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: provider.provider }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: provider.answered ? "yes" : /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "muted", children: provider.error ?? "no_reading" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: provider.answered ? provider.source : "—" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: provider.answered ? provider.freshness : "—" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: provider.answered ? `v${provider.adapter_version}` : "—" })
      ] }, provider.provider)) })
    ] })
  ] });
}
...
function HistoryChart({ points, label }) {
  if (points.length < 2) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "muted chart__empty", children: [
      "Not enough readings yet to draw ",
      label,
      ". Run collect again."
    ] });
  }
  ...
  const x = (t) => PAD + (t - first) / span * (WIDTH - PAD * 2);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: PAD, y1: y(100), x2: WIDTH - PAD, y2: y(100), className: "chart__grid" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: PAD, y1: y(50), x2: WIDTH - PAD, y2: y(50), className: "chart__grid" }),
        segments.filter((segment) => segment.length > 1).map((segment, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "polyline",
          {
            className: "chart__line",
            points: segment.map((point) => `${x(point.collected_at)},${y(point.used_percent)}`).join(" ")
          },
          index
        )),
        points.slice(-1).map((point) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
...
function ProviderCard({ provider, forecast }) {
  if (!provider.answered) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "card card--silent", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: provider.provider }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pill pill--silent", children: "no answer" })
      ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: `card card--${tone}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("dl", { className: "facts", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { children: hasForecast(forecast) && forecast ? forecast.status === "window_spent" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "spent", children: "already fully used" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        " ",
        "at ",
        forecast.burn_rate_per_hour?.value?.toFixed(1),
        "%/h",
        forecast.resets_before_exhausted ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "muted", children: " — resets first, so it will not run out" }) : null
      ] }) : (
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "page", children: [
    ...
    snapshot ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Headroom, { providers: snapshot.providers }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Providers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cards", children: snapshot.providers.map((provider) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cardslot", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ProviderCard,
            {
              provider,
          ...
          provider.answered ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            HistoryChart,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Health, { providers: snapshot.providers })
    ] }) : null,
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "page__footer", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "muted", children: "A provider that did not answer is shown as not answering, never as zero usage. A forecast that cannot be measured reports why instead of a number." }) })
  ] });
}
